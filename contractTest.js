...
var Q = require("q");
var makeContractHost = require("./makeContractHost");
var makeMint = require("./makeMint");
var escrowExchange = require("./escrowExchange");
var makeAlice = require("./makeAlice");
var makeBob = require("./makeBob");
...
Q(bobP).send('tradeWell', aliceP).then(function(v) {
    if (v === 10) {
        console.log("exchange succeeded!");
    } else {
        throw new Error("bad result: " + v);
    }
}).done();
